...
@Stateless
public class AdminUtilidadesBean implements AdminUtilidades {
    ...
    public String valorEnLetras(int numero){
        ...
        String valorLetras = decmillon(numero);
        return valorLetras;
    }
    ...
    /*
     * Por El Gatopardo
     * Método para la ejecución periódica de la recolección de basura
     */
    @Schedule(hour = "0,7,13,19")
    public void garbageCollect(){
        try{
            adminLogGeneral.logConsola("Forzando recolección de basura");
            System.gc();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
